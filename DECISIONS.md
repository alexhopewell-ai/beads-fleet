# beads_web Decisions Log

**Decisions affecting this project**

---

## Decision 1: Extend beads_web for Factory Integration
**Date:** 2026-02-15
**Decision:** Extend beads_web with factory-specific features rather than the factory building a separate dashboard
**Reasoning:**
- beads_web already provides ~80% of what the factory's COMPLETE_SYSTEM.md designed from scratch
...
- Jane already uses beads_web daily
...
**Date:** 2026-02-15
**Decision:** The factory agent works directly in the beads_web repo when needed, rather than coordinating with a separate beads_web agent
**Reasoning:**
