...
**Goal:** Extend beads_web to serve as the Cycle Apps Factory's dashboard

**Context:** The cycle-apps-factory project is building an autonomous iOS app factory. Rather than building a separate dashboard, we're extending beads_web with factory-specific features. See `factory-agent-prompt.md` and `agent_convo.md` for full background.

---

## Current State

beads_web already provides:
...
Factory bootstrap work (pattern extraction, standards library) happens first and doesn't need any beads_web changes. The factory integration features become relevant when:
